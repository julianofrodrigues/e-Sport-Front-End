            ...
            <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd}  action="" className='mt-8 flex flex-col gap-4'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <select id='game' name='game' className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none'>
                        <option disabled selected value="">Selecione o game</option>
                        { games.map(game => {
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <Input name='name' id='name'  placeholder='Qual o seu nickname' />
                  </div>
                  ...
                  <div className='grid grid-cols-2 gap-6'>
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <Input name='discord' id='discord' type='text' placeholder='Úsuario#0000' />
                    </div>
                  </div>
